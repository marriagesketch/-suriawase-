...
const RADIO_LABELS = {
  ...
  /* Q36 */ "a36-1":"毎回一緒に会いたい",
            ...
            "a36-4":"宿泊はしなくてもよいが、たまにはついてきてほしい",
            "a36-5":"ついてこないでほしい",
  ...
  /* Q40 */ "a40-1":"身だしなみや言葉遣いなども含め、常に気を遣いたい",
            "a40-2":"基本的には気を遣いたいが、ある程度は自然体でもよい",
            "a40-3":"お互い飾らず、何でも自然体でいたい",
};
...
const CHECKBOX_LABELS = {
  ...
  "a29-4":"中古マンション",
  /* Q41 パートナーとの間で嫌なこと */
  "a41-1":"風呂に入る前にベッドでそのままダラダラする",
  "a41-2":"おならやゲップをする",
  "a41-3":"脱いだ服をそのまま置いておく",
  "a41-4":"自身が買ってきて冷蔵庫などに保管していた食べ物、飲み物をパートナーが許可なく食べられる、飲まれる",
  "a41-5":"スマホを勝手に見られる（ロック画面の通知内容含め）",
  "a41-6":"下ネタを話す",
  "a41-7":"ノリで「お前」と言われる",
  "a41-8":"芸能人の不倫などのゴシップを聞かされる",
  "a41-9":"政治や経済について議論する",
  "a41-10":"仕事の愚痴を頻繁に聞かされる",
  "a41-11":"共通の趣味ではない趣味について聞かされる",
  "a41-12":"共通の友人でない人の話（ポジティブな話題もネガティブな話題も問わず）を頻繁に聞かされる",
  "a41-13":"異性の同僚や友人との出来事について聞かされる",
  "a41-14":"異性からナンパされた、2人で食事に誘われたことなどを相手から言わないままにされる",
};
...
function restoreFormData(data) {
  ...
  ["q3","q4","q5","q6","q7","q8","q9","q11","q12","q13","q14","q15",
   ...
   "q31","q33","q34","q35","q36","q37","q38","q39","q40"]
...
function renderViewMode(data, options = {}) {
  ...
  const rows = [
    ...
    { q: "Q40 日常生活では、お互いにどの程度気を遣い続けたいですか？", a: lbl(data.q40) },
    { q: "Q41 パートナーとの間で、これをされるのは嫌だというものはどれですか？", html: chkListHTML(data.q41) },
  ];
